...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/user.UserService/SendMessage',
                request_serializer=user__service__pb2.MessageRequest.SerializeToString,
                response_deserializer=user__service__pb2.MessageResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__service__pb2.MessageRequest.FromString,
                    response_serializer=user__service__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def SendMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserService/SendMessage',
            user__service__pb2.MessageRequest.SerializeToString,
            user__service__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
